...
describe("filterSessions", () => {
  const sessions = [
    makeSession({ sessionId: "s1", name: "Refactor auth", cwd: "/Users/ser/projects/alpha" }),
    makeSession({ sessionId: "s2", name: null, cwd: "/Users/ser/projects/beta" }),
    makeSession({ sessionId: "s3", name: "Beta docs", cwd: "/Users/ser/projects/gamma", git: { branch: "feat/docs", dirty: false } }),
  ];
